...
import TicketContent from "../Containers/TicketContent/TicketContent";
const TicketContentLayout = () => {
    ...
    return(
        <Fragment>
            {roleStore !== "admin" ? navigate("/") : <TicketContent/> }
        </Fragment>
    )

}
export default TicketContentLayout